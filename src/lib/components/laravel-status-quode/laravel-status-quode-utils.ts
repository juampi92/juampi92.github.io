...
export function trackQuizAnswer(
	...
	trackEvent('laravel_status_quode_quiz_answer', {
...
export function trackQuizComplete(score: number, total: number) {
	trackEvent('laravel_status_quode_quiz_complete', {
		score,
		total,
...
export function trackQuizShare(hasName: boolean, score: number, total: number) {
	trackEvent('laravel_status_quode_quiz_share', { has_name: hasName, score, total });
}
