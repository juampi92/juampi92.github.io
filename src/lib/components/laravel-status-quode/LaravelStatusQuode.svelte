<script lang="ts">
	...
	} from './laravel-status-quode-utils';
	import type {
		QuizData,
	...
	import QuizQuestion from './LaravelStatusQuodeQuestion.svelte';
	import QuizResults from './LaravelStatusQuodeResults.svelte';
	import QuizShareBanner from './LaravelStatusQuodeShareBanner.svelte';
