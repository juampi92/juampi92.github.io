...
thumbnail_image: "./5-grouping-routes.jpg"
---
...
A popular approach to route grouping can be grouping by **domain**. You can take the example of this [Laravel News article](https://laravel-news.com/managing-routes).
